...
def take_all_messages_by_chat_id(chat_id: int) -> Message:
...
def take_all_messages_in_chat_after_message_id(chat_id: int, message_id: int) -> Message:
...
def add_new_user_in_db(curr_login, curr_password) -> bool:
    user = User(
        login=curr_login,
...
def add_new_session_in_db(curr_user_data) -> str:
